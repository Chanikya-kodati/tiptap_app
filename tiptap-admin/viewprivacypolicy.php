...
{			
	...
	$login_query = "UPDATE tiptap_aboutus SET content='$content', contentar='$contentar' WHERE id=2";
	...
	if($res == 1){
		header("location:viewprivacypolicy.php?msg=success");	
	} else {		
		header("location:viewprivacypolicy.php?msg=fail");
	}	
}	
?>
        <!-- page content -->
        <div class="right_col" role="main">
          <div class="">
			...
			<?php
				$banner_que = "SELECT * from tiptap_aboutus where id=2";
				$database1 = new Database();
				$dbCon1 = $database1->getConnection();
