...
?>
        ...
        <div class="right_col" role="main">
          <div class="">
			...
			<a align="right" href="badge_addnew.php"><button class="btn btn-success"><i class="fa fa-plus"></i> Add Badge</button></a>	
            <div class="clearfix"></div>
            <div class="row">             
             <div class="clearfix"></div>
                  ...
                  <div class="x_content"> 
                    <div class="table-responsive">
                      <table id="datatable" class="table table-striped jambo_table bulk_action">
						...
						<?php
						$i = 1;						
						$banner_que = "SELECT * from tiptap_badges where 1=1 ORDER BY id DESC";
						...
						?>
                          <tr class="even pointer">                            
							...
							<a class="btn btn-info" href="badges_edit.php?id=<?php echo $banner_result['id'] ?>">Edit</a>&nbsp;
...
$(function(){
	$("[id^='delete_']").click(function(){
     	var i=$(this).attr('id');		
			...
			type:"POST",
			data:"id="+i,
			url:"deletecollection.php?type=badge",
...
$(function(){
	$("[id^='status_']").click(function(){
		...
		var j=arr2[1];
			...
			type:"POST",
			data:"id="+i+"&"+j,
			url:"changestatus.php?type=badge",
			success:function(data)
			{
				if(data=="done")
				{
