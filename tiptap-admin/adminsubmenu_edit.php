...
{	
	...
	$login_query = "UPDATE tiptap_adminsubmenu SET adminmenuid='$menu', submenuname='$subname', link='$link' WHERE id=$id";
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
				  ...
				  <?php					
					$about_query = "SELECT * from tiptap_adminsubmenu where id=$id";
