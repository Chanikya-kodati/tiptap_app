...
?>
        ...
        <div class="right_col" role="main">
          <div class="">
			...
			<a align="right" href="landingbanner_addnew.php"><button class="btn btn-success"><i class="fa fa-plus"></i> Add Landing Banner</button></a>	
            <div class="clearfix"></div>
            <div class="row">             
             <div class="clearfix"></div>
                      ...
                      <table id="datatable" class="table table-striped jambo_table bulk_action">
                        <thead>
                          <tr class="headings">    
							...
							<th width="300" class="column-title">Title</th>
							<th width="300" class="column-title">Image</th>
						...
						<?php
						$i = 1;						
						$banner_que = "SELECT * from tiptap_landingbanners where 1=1 ORDER BY id DESC";
						...
						?>
                          <tr class="even pointer">                            
                            ...
                            <td class=" ">
							<?php
							if($banner_result['image']!=""){
							?>
								<img src="../<?php echo $banner_result['image']; ?>" width="100" height="100">
							<?php }	?>
							</td>						
							...
							<a class="btn btn-info" href="landingbanner_edit.php?id=<?php echo $banner_result['id'] ?>">Edit</a>&nbsp;
...
$(function(){
	$("[id^='delete_']").click(function(){
     	var i=$(this).attr('id');		
			...
			type:"POST",
			data:"id="+i,
			url:"deletecollection.php?type=landbanner",
...
$(function(){
	$("[id^='status_']").click(function(){
		...
		var j=arr2[1];
			...
			type:"POST",
			data:"id="+i+"&"+j,
			url:"changestatus.php?type=landbanner",
			success:function(data)
			{
				if(data=="done")
				{
