...
?>
        ...
        <div class="right_col" role="main">
          <div class="">
			...
			<a align="right" href="role_addnew.php"><button class="btn btn-success"><i class="fa fa-plus"></i> Add Role</button></a>	
            <div class="row">
              <div class="clearfix"></div>
                  ...
                  <div class="x_content"> 
                    <div class="table-responsive">
                      <table class="table table-striped jambo_table bulk_action">
						...
						<?php
						$i = 1;						
						$adminsub_que = "SELECT * from 	tiptap_roles where companyid=$companyid ORDER BY id DESC";
						...
						?>
                          <tr class="even pointer">
							...
							<a class="btn btn-info" href="role_edit.php?id=<?php echo $banner_result['id'] ?>"><i class="fa fa-edit"></i></a>&nbsp; 
...
$(function(){
	$("[id^='delete_']").click(function(){
     	var i=$(this).attr('id');		
			...
			type:"POST",
			data:"id="+i,
			url:"deletecollection.php?type=role",
