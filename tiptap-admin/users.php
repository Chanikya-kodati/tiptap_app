...
?>
        ...
        <div class="right_col" role="main">
          <div class="">
			...
			<a align="right" href="user_addnew.php"><button class="btn btn-success"><i class="fa fa-plus"></i> Add Employee</button></a>	
            <div class="row">
              <div class="clearfix"></div>
                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        <thead>
                          <tr class="headings">    
                            ...
                            <th width="300" class="column-title">Code </th>
						...
						?>
                          <tr class="even pointer">
                            ...
                            <td class=" "><?php echo $banner_result['secretcode'] ?></td>		
                            <td style="text-align:center" class=" last">
							<a class="btn btn-info" href="user_edit.php?id=<?php echo $banner_result['id'] ?>"><i class="fa fa-edit"></i></a>&nbsp; 
