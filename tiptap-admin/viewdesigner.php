          ...
          <div class="">
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                      ...
                      <table id="datatable" class="table table-striped jambo_table bulk_action">
                        <thead>
                          <tr class="headings">                            
							...
							<th width="300" class="column-title">Received from</th>							
							<th width="300" class="column-title">Amount</th><th width="300" class="column-title">Received On </th>
						...
						$banner_que = "SELECT * from tiptap_tipsamttoreceivers where receiverid=$id $cond ORDER BY id DESC";
						...
						foreach($menbanner_res as $banner_result)						
						{
							...
							$giveridinfo = getCustomerInfo($banner_result['giverid']);
						?>
                          <tr class="even pointer">  
                            <td class=" "><?php echo $i ?></td>	
							<td class=" "><?php echo $giveridinfo['fullname']; ?></td>
				...
				<a href="viewalltipgivers.php" class="btn btn-primary">Back</a>
				</div>			  
				</div>					  
			  </div>				  
			</div>				
