  ...
  $(document).ready(function() {
	var data1 = [	
	  ...
	  for($days=1;$days<=$noofdays;$days++){
			...
			$banner_que = "SELECT count(*) as prodcount from animall_cartproducts where status=2 date BETWEEN '$startnowdate' AND '$endnowdate' GROUP BY orderid";
      ...
      $(document).ready(function() {
        ...
        var d1 = [
		  ...
		  for($days=1;$days<=$noofdays;$days++){
			...
			$banner_que = "SELECT * from animall_customers where registereddate BETWEEN '$startnowdate' AND '$endnowdate'";
			$database1 = new Database();
			$dbCon1 = $database1->getConnection();
			$stmt1 = $dbCon1->prepare($banner_que);  
			$stmt1->execute();
