...
{			
	...
	$login_query = "UPDATE tiptap_servicecharge SET amount='$amount' WHERE id='2'";
	...
	if($res11 == 1){
		header("location:transferlimitamount.php?msg=success");		
	} else {		
		header("location:transferlimitamount.php?msg=fail");		
	}	
}	
?>
        <!-- page content -->
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Transfer limit Amount</h2>                    
                    <div class="clearfix"></div>
                  </div>
				  <?php
					$banner_que = "SELECT * from tiptap_servicecharge where id=2";
					$database1 = new Database();
					$dbCon1 = $database1->getConnection();
