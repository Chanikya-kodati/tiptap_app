        ...
        <div class="right_col" role="main">
          <div class="">
            ...
            <div class="clearfix"></div>			
				<a align="right" href="tipamount_addnew.php"><button class="btn btn-success"><i class="fa fa-plus"></i> Add Tip Amount</button></a>			
			<div class="clearfix"></div>
            <div class="row">           
              <div class="clearfix"></div>
                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        <thead>
                          <tr class="headings">      
							...
							<th width="300" class="column-title">Tip Amount</th>
						...
						<?php
						$i = 1;						
						$banner_que = "SELECT * from tiptap_tipamounts where 1=1 ORDER BY id DESC";
						...
						?>
                          <tr class="even pointer">
							...
							<a class="btn btn-info" href="tipamount_edit.php?id=<?php echo $banner_result['id'] ?>">Edit</a>&nbsp; 
...
$(function(){
	$("[id^='delete_']").click(function(){
     	var i=$(this).attr('id');		
			...
			type:"POST",
			data:"id="+i,
			url:"deletecollection.php?type=tipamount",
...
$(function(){
	$("[id^='status_']").click(function(){
		...
		var j=arr2[1];
			...
			type:"POST",
			data:"id="+i+"&"+j,
			url:"changestatus.php?type=tipamount",
			success:function(data)
			{
				if(data=="done")
				{
