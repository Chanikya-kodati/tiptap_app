...
{			
	...
	$adminmenu_query = "INSERT INTO tiptap_adminmenu (id, menuname) VALUES ('', '$title')";
	...
	{		
		$id = $banner_result['id'];		
		if($id==$loginid){						
			$product_sql = "INSERT INTO `tiptap_usermenulist` (`id`, `adminmenuid`, `menusubmenurel`, `adminsubmenuid`, `userid`, `status`) VALUES ('', $admid, 0, 0, $loginid, 1)";
