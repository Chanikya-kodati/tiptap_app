...
{			
	...
	{			
		...
		if (($ext == "jpg") || ($ext == "jpeg") || ($ext == "png")) {
			...
			if (move_uploaded_file($_FILES['image']['tmp_name'], $target_file1)) {	
				$login_query = "UPDATE tiptap_giverreceiverbanners SET giverprofilepageimage='$blocation1' WHERE id=1";
	...
	{			
		...
		if (($ext == "jpg") || ($ext == "jpeg") || ($ext == "png")) {
			...
			if (move_uploaded_file($_FILES['bannerimage']['tmp_name'], $target_file1)) {	
				$login_query = "UPDATE tiptap_giverreceiverbanners SET receiverprofilepageimage='$blocation1' WHERE id=1";
				$database1 = new Database();
				$dbCon1 = $database1->getConnection();
				$stmt1 = $dbCon1->prepare($login_query);  
				$stmt1->execute();
	...
	if($res1 == 1|| $res11 == 1){
		header("location:giverreceiverprofileimages.php?msg=success");		
	} else {		
		header("location:giverreceiverprofileimages.php?msg=fail");		
	}	
}	
?>
<!-- page content -->
  ...
  <div class="">
	<div class="page-title">
	  <div class="title_left">
		<h3>Giver & Receiver profile page banners </h3>
	  </div>
	<?php
	...
	<div class="row">
	  <div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel">
		  <div class="x_title">
			<h2>Giver & Receiver profile page banners</h2>                    
			<div class="clearfix"></div>
		  </div>
		  <div class="x_content">
			<br/>
			 ...
			 <div class="form-group">
				...
				<div class="col-md-6 col-sm-6 col-xs-12">
				  ...
				  <div class="control-group">					
					<div class="controls">
						<div align="left"><br/>
						<?php if($about_res['giverprofilepageimage']!=""){ ?>
							<img src="../<?php echo $about_res['giverprofilepageimage'] ?>" width="250px" height="250px"/>
						<?php } ?>
			  ...
			  <div class="form-group">
				...
				<div class="col-md-6 col-sm-6 col-xs-12">
				  ...
				  <div class="control-group">					
					<div class="controls">
						<div align="left"><br/>
						<?php if($about_res['receiverprofilepageimage']!=""){ ?>
							<img src="../<?php echo $about_res['receiverprofilepageimage'] ?>" width="250px" height="250px"/>
						<?php } ?>	
						</div>	
					</div>
				</div>
