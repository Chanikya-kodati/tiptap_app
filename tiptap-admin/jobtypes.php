        ...
        <div class="right_col" role="main">
          <div class="">
            ...
            <div class="clearfix"></div>			
				<a align="right" href="jobtype_addnew.php"><button class="btn btn-success"><i class="fa fa-plus"></i> Add Job Type</button></a>			
			<div class="clearfix"></div>
            <div class="row">           
              <div class="clearfix"></div>
                  ...
                  <div class="x_content"> 
                    <div class="table-responsive">
                      <table class="table table-striped jambo_table bulk_action">
						...
						<?php
						$i = 1;						
						$banner_que = "SELECT * from tiptap_jobtypes where 1=1 ORDER BY id DESC";
						...
						?>
                          <tr class="even pointer">
							...
							<a class="btn btn-info" href="jobtype_edit.php?id=<?php echo $banner_result['id'] ?>">Edit</a>&nbsp; 
...
$(function(){
	$("[id^='delete_']").click(function(){
     	var i=$(this).attr('id');		
			...
			type:"POST",
			data:"id="+i,
			url:"deletecollection.php?type=jobtype",
...
$(function(){
	$("[id^='status_']").click(function(){
		...
		var j=arr2[1];
			...
			type:"POST",
			data:"id="+i+"&"+j,
			url:"changestatus.php?type=jobtype",
			success:function(data)
			{
				if(data=="done")
				{
