          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Industry Type</h3><hr>
              </div>             
            </div>
            <div class="clearfix"></div>			
				<a align="right" href="industrytype_addnew.php"><button class="btn btn-success"><i class="fa fa-plus"></i> Add Industry Type</button></a>			
			<div class="clearfix"></div>
            <div class="row">           
              <div class="clearfix"></div>
                  ...
                  <div class="x_content"> 
                    <div class="table-responsive">
                      <table class="table table-striped jambo_table bulk_action">
						...
						<?php
						$i = 1;						
						$banner_que = "SELECT * from tiptap_industrytype where 1=1 ORDER BY id DESC";
						...
						?>
                          <tr class="even pointer">
							...
							<a class="btn btn-info" href="industrytype_edit.php?id=<?php echo $banner_result['id'] ?>">Edit</a>&nbsp; 
...
$(function(){
	$("[id^='delete_']").click(function(){
     	var i=$(this).attr('id');		
			...
			type:"POST",
			data:"id="+i,
			url:"deletecollection.php?type=industrytype",
...
$(function(){
	$("[id^='status_']").click(function(){
		...
		var j=arr2[1];
			...
			type:"POST",
			data:"id="+i+"&"+j,
			url:"changestatus.php?type=industrytype",
			success:function(data)
			{
				if(data=="done")
				{
