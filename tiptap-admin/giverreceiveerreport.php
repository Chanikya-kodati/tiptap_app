			  ...
			  <p>
				<div class="row">
					<div cla ss="col-md-1 col-sm-12 col-xs-12" style="float:right">
						...
						<a class="btn btn-success" href="walletrechargetrans.php"><i class="fa fa-refresh"></i> Reset</a>
					</div>					
                      ...
                      <table id="datatable" class="table table-striped jambo_table bulk_action">
                        <thead>
                          <tr class="headings">                            
							...
							<th width="300" class="column-title">Payer</th>			
							<th width="300" class="column-title">Recipient</th>
						...
						$banner_que = "SELECT * from tiptap_tipsamttoreceivers where 1=1 $cond ORDER BY id DESC";
