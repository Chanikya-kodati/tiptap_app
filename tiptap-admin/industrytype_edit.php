...
{			
	...
	$login_query = "UPDATE tiptap_industrytype SET title='$amount',titlear='$amountar' WHERE id='$id'";
	...
	if($res11 == 1){
		header("location:industrytypes.php?msg=success");		
	} else {		
		header("location:industrytypes.php?msg=fail");		
	}	
}	
?>
        <!-- page content -->
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
				  ...
				  <?php
					$banner_que = "SELECT * from tiptap_industrytype where id=$id";
					$database1 = new Database();
					$dbCon1 = $database1->getConnection();
                    ...
                    <form action="" method="post" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <a href="industrytypes.php" class="btn btn-primary">Cancel</a>
