                      ...
                      <table id="datatable" class="table table-striped jambo_table bulk_action">
                        <thead>
                          <tr class="headings">      
							...
							<th width="100" class="column-title">Tip Receiver ID </th>
							<th width="200" class="column-title">Full Name</th>
							<th width="150" class="column-title">Mobile </th>
							<th width="150" class="column-title">User Type </th>
							<th width="200" class="column-title">Company </th>
							<th width="200" class="column-title">Latest Tip Received Date </th>
						...
						<?php
						$i = 1;
						$banner_que = "SELECT * from tiptap_customers where 1=1 AND giverorreceiver=2 ORDER BY id DESC";
